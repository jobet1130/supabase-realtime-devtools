...
interface SupabaseRealtimeDevToolsProps {
  supabaseClient?: any;
...
const SupabaseRealtimeDevTools: React.FC<SupabaseRealtimeDevToolsProps> = ({
  supabaseClient,
      ...
      >
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span
              className={cn(
                "text-sm font-mono font-semibold bg-",
...
export default SupabaseRealtimeDevTools;
